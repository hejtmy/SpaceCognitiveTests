    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pb-12 md:pb-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12">
          <h2 class="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Stop overpaying for software</h2>
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <!-- Card #1 -->
          <div class="bg-gradient-to-tr from-slate-800/50 to-slate-800/10 rounded-3xl border border-slate-800">
